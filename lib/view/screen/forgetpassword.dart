      ...
      body: SafeArea(
          child: Form(
            child: Padding(
              ...
              child: GetBuilder<ForgetPasswordController>(builder: (forgetpasswordController) {
                return Center(
                  child: Column(children: [
                    ...
                    AuthTextField(
                      ...
                      authTextEditingcontroller:forgetpasswordController.emailVerification,
                      valid: (val) {
                        return validinput(val!,5,40,"email");
                      },
                    ),
                    const AuthButton(textAuth: "Send OTP")
                  ]),
                );
              }),
            ),
